...
export interface WorkspaceTab {
  ...
  readonly layout:
    ...
    | "grid-3-top"
    | "grid-4";
  readonly chartSlots: readonly WorkspaceChartSlot[];
}
...
function isChartSlot(value: unknown): value is WorkspaceChartSlot {
  return (
    isObject(value) &&
    hasFields(
      value,
...
function isWorkspaceV1(value: unknown): value is WorkspaceV1 {
  return (
    isObject(value) &&
    hasFields(value, [
      "schemaVersion",
...
export function validateWorkspaceV1(value: unknown): value is WorkspaceV1 {
  try {
    return isWorkspaceV1(value);
  } catch {
    return false;
  }
}
...
function readWorkspaceVersion(value: unknown): unknown {
  try {
    return isObject(value) && Object.hasOwn(value, "schemaVersion")
      ? value.schemaVersion
      : 1;
  } catch {
    return 1;
...
export function serializeWorkspaceV1(value: unknown): string {
  ...
  if (!validateWorkspaceV1(value))
    throw new Error("Invalid workspace v1 document.");
  return JSON.stringify(value);
}

export function parseWorkspaceV1(serialized: string): WorkspaceV1 {
  let value: unknown;
  try {
