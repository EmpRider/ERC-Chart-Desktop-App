...
|   3 | Inputs have static identity, source semantics and dynamic-multiplicity rejection.                                                                         | Compiler extracts declarations and source inputs while runtime source tokens remain internal. Repeated array-style callbacks that can execute an input directly or through a helper now fail during authoring compilation. | Fresh input identity/reorder/helper/loop/recursion/repeated-callback package coverage in integration.                      | PASS                      |
